...
extern int dc_toptwoel DC_PROTO((void));
...
extern dc_data dc_forcestring DC_PROTO((dc_data));
extern dc_data dc_addstring DC_PROTO((dc_data,dc_data));
extern dc_data dc_readstring DC_PROTO((FILE *, int , int));
extern dc_data dc_char2string DC_PROTO((char));
extern void dc_strsep DC_PROTO((dc_data,dc_data));
